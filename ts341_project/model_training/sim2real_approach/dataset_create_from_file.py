...
def drone_space_to_camera_space(camera_obj, FOV, borne_dist):
    ...
    target_point = mathutils.Vector((alea_x, alea_y, - alea_z)) #Z négatif = devant la caméra
    print("Pente_x:", pente_x, "Pente_y:", pente_y, "x:", alea_x, "y:", alea_y, "z:", alea_z)
...
def move_scene(drone_obj, borne_dist,theta_bornes):
    ...
    work_obj_coos = drone_space_to_camera_space(camera_obj, math.radians(60), borne_dist)
